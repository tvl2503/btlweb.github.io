        ...
        <div class="layout--top">
              ...
              <div class="swiper-wrapper">
                <a href="">
                  <div class="swiper-slide">
                    <div class="card--item">
                      <img
                        src="./images/static/8_16aacde4-7a2d-4cc7-a7c0-0f96a08f41d7_540x.jpeg"
                      />
                      <div class="d-flex justify-between align-center content--card">
                        <div class="left--card">
                          <p class="f-20 pb-4">Sandals</p>
                          <p class="f-14">6 Items</p>
                        </div>
                        <a
                          href=""
                ...
                <a href=""
                  ><div class="swiper-slide">
                    <div class="card--item">
                      <img
                        src="./images/static/6_37a6a5fc-944e-4249-ac0f-747b11508859_880x.jpeg"
                      />
                      <div class="d-flex justify-between align-center content--card">
                        <div class="left--card">
                          <p class="f-20 pb-4">Sandals</p>
                ...
                <a href=""
                  ><div class="swiper-slide">
                    <div class="card--item">
                      <img
                        src="./images/static/1_99801259-b43a-4a6e-bd8c-b12b261f6d88_720x.jpeg"
                      />
                      <div class="d-flex justify-between align-center content--card">
                        <div class="left--card">
                          <p class="f-20 pb-4">Sandals</p>
                ...
                <a href=""
                  ><div class="swiper-slide">
                    <div class="card--item">
                      <img
                        src="./images/static/7_f415264b-8244-46fc-bd83-f55a5d62851a_720x.jpeg"
                      />
                      <div class="d-flex justify-between align-center content--card">
                        <div class="left--card">
                          <p class="f-20 pb-4">Sandals</p>
          ...
          <div class="container pt-64 pb-64 container--items">
            ...
            <div class="d-grid grid-col-4 gap-16 pt-40 list--products">
              <div class="single--product">
                <div class="d-block image--product">
                  <img
                    src="./images/static/49a_345f6a56-aa62-4074-8544-b927fd02cfd2_540x.jpeg"
                    alt=""
                  />
                  <ul class="d-flex justify-center align-center options--product">
                    ...
                    <li data-tooltip="Quick view"><i class="far fa-eye"></i></li>
                    <li data-tooltip="Compare"><i class="far fa-sort-alt"></i></li>
                  </ul>
                </div>
                <div class="pt-20 data--product">
                  <a class="pb-4 f-14" href="">Rounded Sunglasses</a>
                  <p class="f-14">$8.00</p>
                </div>
              </div>
              <div class="single--product">
            ...
            <div class="pt-20 text-center">
              <button class="btn btn-black text-uppercase">Watch more</button>
            </div>
          </div>
